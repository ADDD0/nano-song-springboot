...
public class QuerySongController {
    ...
    @ResponseBody
    public ResponseEntity<QuerySongResponse> query(@RequestBody @Validated @NotEmpty QuerySongByPerformanceDateRequest request)
    ...
    @ResponseBody
    public ResponseEntity<QuerySongResponse> query(@RequestBody @Validated @NotEmpty QuerySongBySongCollectionIdRequest request)
